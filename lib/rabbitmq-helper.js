...
var SetupRabbitMQHelper = function setupRabbitMQHelper(options, eventHandlers) {
    ...
    require('./validators/config')(config, function (err) {
        if (err) {
            ...
            helpers.ensureExchange = EnsureExchange;
            ...
            helpers.ensureQueue = EnsureQueue;
            ...
            helpers.bindQueueToExchange = BindQueueToExchange;
            ...
            helpers.bindListenerToQueue = BindListenerToQueue;
